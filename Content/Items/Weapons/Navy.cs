...
namespace HellPlus.Content.Items.Weapons
{
    public class Navy : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 85; // The amount of damage the item does to an enemy or player.
            ...
            Item.knockBack = 3.4f; // The amount of knockback the item inflicts.
            ...
            Item.shoot = ModContent.ProjectileType<NavyProjectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
