...
{
    public class MasterStaffProjectileAltA : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust dust;
            if (Main.rand.NextBool(960))
                switch (type)
                {
                    case 0:
                        dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Enchanted_Gold, Scale: 1f);
                        break;
                    case 1:
                        dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Enchanted_Pink, Scale: 1f);
                        break;
                }
            }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
                target.SimpleStrikeNPC(Main.rand.Next(250, 350), 0);
            }
