...
{
    public class NavyProjectile : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.scale = 1.15f; // The scale of the projectile. Most yoyos are 1f, but a few are larger. The Kraken is the largest at 1.2f
